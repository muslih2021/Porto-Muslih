...
const roleServices = {
  general: [
    { title: "Video Editor (After Effects & CapCut)", icon: creator },
    { title: "Graphic Designer (Figma, Picsart & Canva)", icon: backend },
    { title: "Web Developer (React, Node, Laravel)", icon: web },
    { title: "Data Analyst (Excel, Python, Power BI)", icon: mobile },
  ],
  data_analis: [
    { title: "Excel (Data Processing & Visualization)", icon: creator },
    { title: "Python (Pandas, NumPy, Scikit-learn)", icon: backend },
    { title: "Power BI (Interactive Dashboards)", icon: web },
    { title: "SQL & Relational Databases", icon: mobile },
  ],
  video_editor: [
    { title: "Video Editor (After Effects & CapCut)", icon: creator },
    { title: "Graphic Designer (Figma, Picsart & Canva)", icon: backend },
    { title: "Motion Graphics (After Effects)", icon: web },
    { title: "Visual Storytelling", icon: mobile },
  ],
  programmer: [
    { title: "Frontend (JS, React, HTML, CSS)", icon: creator },
    { title: "Backend (Node.js, Express, PHP, Laravel)", icon: backend },
    { title: "Mobile & Desktop (Java, Kotlin)", icon: mobile },
    { title: "UI Frameworks (Bootstrap, Tailwind CSS)", icon: web },
  ]
};

// Fallback for backwards compatibility if needed, though we will update About.tsx to use roleServices
const services = roleServices.video_editor;
...
const projects: TProject[] = [
  {
    ...
    tags: [
      ...
      { name: "scss", color: "orange-text-gradient" },
    ],
    image: persuratan,
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "java fx", color: "green-text-gradient" },
    ],
    image: rental,
  ...
  },
  {
    ...
    tags: [
      ...
      { name: "data-validation", color: "pink-text-gradient" },
    ],
    image: talaud,
    sourceCodeLink: "",
  }
...
export { services, roleServices, technologies, experiences, testimonials, projects };
